...
Name: Atlee Hlavinka
Project: Project 4
Description: listemployees page for the Idaho Souvenir Store
Log:

02/09/2022 - Created listemployees.php page. Set up database and employee classes.
02/11/2022 - Updated by putting classes into the model folder and then calling to
them.
-->
    ...
    <body class="backgroundimg">
        ...
        <main>
          ...
          <div class="container sectiontitle">
            <h1 class="mt-5 text-center ">Employee List</h1>
          </div>
