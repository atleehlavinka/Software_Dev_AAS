...
class DebugFour3
{
    static void Main()
    {
        int credits, year; // replaced ';' with ','
        string inputString;
        double tuition;
        const int LOWCREDITS = 12;
        const int HIGHCREDITS = 18;
        const double HOURFEE = 150.00; //Updated 15000 to 150.00
